# Simulator star rendering

## Purpose

Phase 1 synthetic frames: radiometric mapping from stellar magnitude to sensor intensity, baseline PSF rasterization, dynamic-range clipping, and configurable degradations.
